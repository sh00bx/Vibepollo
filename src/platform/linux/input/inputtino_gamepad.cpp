...
namespace platf::gamepad {
  ...
  auto create_xbox_one() {
    return inputtino::XboxOneJoypad::create({.name = inputtino_name_for_seat("Apollo X-Box One (virtual) pad"sv),
  ...
  auto create_switch() {
    return inputtino::SwitchJoypad::create({.name = inputtino_name_for_seat("Apollo Nintendo (virtual) pad"sv),
  ...
  auto create_ds5(int globalIndex) {
    ...
    return inputtino::PS5Joypad::create({.name = inputtino_name_for_seat("Apollo PS5 (virtual) pad"sv), .vendor_id = 0x054C, .product_id = 0x0CE6, .version = 0x8111, .device_phys = device_mac, .device_uniq = device_mac});
  }
